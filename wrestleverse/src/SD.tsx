...
> = {
  ...
  "Tag Teams": [
    ...
    { className: 'ALLSD ',src: "/src/Images/Roster/TagTeam/DudleyBoys.png", name: "Dudley Boys", Champion:"SDTT"},
...
SDData.ALL = [
  ...
  { className: "ALLSD", src: "/src/Images/Roster/BaronCorbin.png", name: "Baron Corbin", gender: "Man", },
  ...
  { className: "ALLSD", src: "/src/Images/Roster/CodyRhodes.png", name: "Cody Rhodes", gender: "Man", Champion: "MMITB"},
  ...
  { className: "ALLSD", src: "/src/Images/Roster/DrewMcintyre.png", name: "Drew Mcintyre", gender: "Man", Champion:"WH"},
  ...
  { className: "ALLSD", src: "/src/Images/Roster/Je'vonEvans.png", name: "Je'von Evans", gender: "Man", Champion:"IC"  },
  ...
  { className: "ALLSD", src: "/src/Images/Roster/KairiSane.png", name: "Kairi Sane", gender: "Women", Champion:"WWH"},
  ...
  { className: "ALLSD", src: "/src/Images/Roster/Naomi.png", name: "Naomi", gender: "Women", },
  ...
  { className: "ALLSD", src: "/src/Images/Roster/RaquelRodriguez.png", name: "Raquel Rodriguez", gender: "Women", },
  ...
  { className: "ALLSD", src: "/src/Images/Roster/SolRuca.png", name: "Sol Ruca", gender: "Women",Champion:"WUS" },
