...
const SmackdownTagTeam: React.FC = () => {
  ...
  const fetchData = async () => {
    const querySnapshot = await getDocs(collection(db, "Wrestleverse", "ChampionshipData", "SmackdownTagTeam"));
  ...
  const addRecord = async () => {
    if (name && days && date && event) {
      ...
      const docRef = await addDoc(collection(db, "Wrestleverse", "ChampionshipData", "SmackdownTagTeam"), newRecord);
  ...
  const deleteRecord = async (id: string) => {
    await deleteDoc(doc(db, "Wrestleverse", "ChampionshipData", "SmackdownTagTeam", id));
    ...
    <div>
      <div className="ChampionshipBackground">
        <div className="ChampionshipContainer">
          <img className="TitleHeaderImage" src="src/Images/CBanners/SDTTBanner.png" alt="Header Background" />
...
export default SmackdownTagTeam;