...
const WomenUnitedStates: React.FC = () => {
  ...
  const fetchData = async () => {
    const querySnapshot = await getDocs(collection(db, "Wrestleverse", "ChampionshipData", "WomenUnitedStates"));
  ...
  const addRecord = async () => {
    if (name && days && date && event) {
      ...
      const docRef = await addDoc(collection(db, "Wrestleverse", "ChampionshipData", "WomenUnitedStates"), newRecord);
  ...
  const deleteRecord = async (id: string) => {
    await deleteDoc(doc(db, "Wrestleverse", "ChampionshipData", "WomenUnitedStates", id));
    ...
    <div>
      <div className="ChampionshipBackground">
        <div className="ChampionshipContainer">
          <img className="TitleHeaderImage" src="src/Images/CBanners/WUSBanner.png" alt="Header Background" />
...
export default WomenUnitedStates;