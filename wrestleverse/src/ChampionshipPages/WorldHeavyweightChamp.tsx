...
const WorldHeavyweight: React.FC = () => {
  ...
  const fetchData = async () => {
    const querySnapshot = await getDocs(collection(db, "Wrestleverse", "ChampionshipData", "WorldHeavyweight"));
  ...
  const addRecord = async () => {
    if (name && days && date && event) {
      ...
      const docRef = await addDoc(collection(db, "Wrestleverse", "ChampionshipData", "WorldHeavyweight"), newRecord);
  ...
  const deleteRecord = async (id: string) => {
    await deleteDoc(doc(db, "Wrestleverse", "ChampionshipData", "WorldHeavyweight", id));
    ...
    <div>
      <div className="ChampionshipBackground">
        <div className="ChampionshipContainer">
          <img className="TitleHeaderImage" src="src/Images/CBanners/WHCBanner.png" alt="Header Background" />
...
export default WorldHeavyweight;