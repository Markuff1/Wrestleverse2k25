...
const RawTagTeam: React.FC = () => {
  ...
  const fetchData = async () => {
    const querySnapshot = await getDocs(collection(db, "Wrestleverse", "ChampionshipData", "RawTagTeam"));
  ...
  const addRecord = async () => {
    if (name && days && date && event) {
      ...
      const docRef = await addDoc(collection(db, "Wrestleverse", "ChampionshipData", "RawTagTeam"), newRecord);
  ...
  const deleteRecord = async (id: string) => {
    await deleteDoc(doc(db, "Wrestleverse", "ChampionshipData", "RawTagTeam", id));
    ...
    <div>
      <div className="ChampionshipBackground">
        <div className="ChampionshipContainer">
          <img className="TitleHeaderImage" src="src/Images/CBanners/RAWTTBanner.png" alt="Header Background" />
