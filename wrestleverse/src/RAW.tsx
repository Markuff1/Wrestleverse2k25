...
RAWData.ALL = [
  ...
  { className: "ALLRAW", src: "/src/Images/Roster/CharlotteFlair.png", name: "Charlotte Flair", gender: "Women", Champion: "WUC"},
  ...
  { className: "ALLRAW", src: "/src/Images/Roster/RoxannePerez.png", name: "Roxanne Perez", gender: "Women"},
