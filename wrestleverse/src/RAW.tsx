...
RAWData.ALL = [
  ...
  { className: "ALLRAW", src: "/src/Images/Roster/BronBreakker.png", name: "Bron Breakker", gender: "Man", Champion: "US"},
  ...
  { className: "ALLRAW", src: "/src/Images/Roster/ObaFemi.png", name: "Oba Femi", gender: "Man"},
  ...
  { className: "ALLRAW", src: "/src/Images/Roster/RandyOrton.png", name: "Randy Orton", gender: "Man"},
  { className: "ALLRAW", src: "/src/Images/Roster/TheRock.png", name: "The Rock", gender: "Man"},
  { className: "ALLRAW", src: "/src/Images/Roster/RobVanDam.png", name: "Rob Van Dam", gender: "Man"},
  { className: "ALLRAW", src: "/src/Images/Roster/RomanReigns.png", name: "Roman Reigns", gender: "Man", Champion:"UC"},
